...
* Index and allow players to search across the metadata stored for each game using AWS Opensearch.
...
### 1. Allow players to search using AWS Opensearch

**Acceptance Criteria**

Given that I am a customer
When I am searching for a game
Then I should be able to search across the metadata stored for each game, using AWS Opensearch

**AWS Opensearch Logic:**
If a customer types 'Blackjack' or '21' it should quickly find all Blackjack games on the website.
...
### 2. Ability to search for results in the search bar

**Acceptance Criteria**

Given that I am a customer
When I want to search for a game
Then I should be able to type in the search bar
And see games that are relevant to what I have searched for as I am typing (starting from 2 letters)
...
### 3. Implement 'fuzzy logic' to ensure results are always displayed

**Acceptance Criteria**

Given that I am a customer
When I am searching for a game
And my search does not match anything
Then I should see results based on proximity to the original search
But if there are no matches, the player should be informed

**Example:**
Toleration of misspellings and typos (e.g. 'blupraint' returns 'Blueprint' and 'jakpot' returns 'Jackpot')
...
Given that I am a customer
When I am searching for a game
Then semantic search should be available
And I will be able to find games based on my intent, rather than exact keyword rules

**Importance**
Must Have

**Notes**
Semantic search is a technique that goes beyond simple keyword matching to understand the meaning and context of a user's search query, aiming to deliver more relevant results. It uses natural language processing (NLP), machine learning (ML), and other AI techniques to analyse the user's intent and provide results that align with that intent, even if the exact keywords are not present in the results

---

### 5. Semantic Search uses the games metadata

**Acceptance Criteria**

Given that I am a customer
When I am searching for a game
Then semantic search should effectively use the games metadata

Ensure all games are tagged with relevant themes and features for enhanced search accuracy.

**Examples:**
If a customer types 'Big Wins' then semantic search should understand you're looking for games where you can win lots of money, and will show popular jackpot or high-paying games to the player.
“I would like to play games like X” Therefore use recommendations for target game X
“I would like to play Blueprint Jackpot Games” Therefore filter to show only BP Jackpot Games
“I want to play quick games with a chance of a big win” therefore filter to instants with high max multipliers (order by max multiplier)

**Importance**
Must Have

**Notes**
An aggregator will display list for games from all supported studio. E.g. Player selecting Games global filter will display all games through this aggregation. Similarly, with Relax, Light and wonder.

Some of the providers/studio might not be live in certain states.

The system should dynamically display game providers list if they are set to status as Live in Contentful in respective jurisdiction.

---

### 6. Search Bar should advise customers what they can search for

**Acceptance Criteria**

Given that I am a customer
When I am looking at the search bar
Then there should be text in the search bar which says 'Search for Games, Providers or Themes'
And this text should be replaced with my search items when I start to type/have typed
...
### 7. Quick Filters to be displayed on the search page

**Acceptance Criteria**

Given that I am a customer
When I am on the search page
Then I should have access to Quick Filters
And I should be able to add/remove these filters from the Quick Filters bar
...
2. **Game Filter menu (main categories(game types))**

   * A modal labeled **GAME FILTER** shows category(game type) cards: *Slots*, *Jackpots*, *Live Casino*, *Table*, *Slingo*, *Bingo*, *Instant*, *Arcade*.
...
5. **Back to main categories(game types)**

   * User returns to the top-level **GAME FILTER** menu of eight categories(game types).
   * **SHOW X GAMES** remains at the bottom.

---

#### *SEARCH · FILTER MENU — All categories(game types)* (iOS · 375×812)

> UI should illustrate the **filter facets** that appear when different categories(game types) are active in the Game Filter modal.
...
* The **Game Filter** modal complements Quick Filters by exposing **full facet menus** (categories(game types), providers, reel/lines, themes, stake range, etc.) with a **“SHOW X GAMES”** confirmation at the bottom.

---

### 8. Quick Filters can be added in Contentful

**Acceptance Criteria**

Given that I am a Bally's Employee using the CMS
When I am configuring the Quick Filters
Then I should be able to add and remove Quick Filters
And the customer should see the filters I have configured

Filters to be added by Product /Gaming Ops
...
### 9. Quick Filters are configurable in Contentful

**Acceptance Criteria**

Given that I am a Bally's Employee using the CMS
When I am configuring the Quick Filters
Then I should be able to change the order the Quick Filters are presented to customer
And the flow they are presented to the customer
...
### 10. Quick Filters should follow a flow

**Acceptance Criteria**

Given that I am a customer
When I am using Quick Filters
Then the filters should follow a flow e.g. for slots, the flow would be Game Type (slot) > Feature > Provider > Reel
...
#### Description 1 — *SEARCH · QUICK FILTERS — User searches for a slot game through quick filters* (iOS · 375×812)

**Flow Example UI/UX:** **Game Type → Feature → Provider → Reel** (then clear).
...
#### Description 2 — *SEARCH · FILTER MENU — User searches for a slot game through filter menu* (iOS · 375×812)
...
2. **Game Filter (main categories(game types))**

   * Full-screen **GAME FILTER** modal shows category(game type) cards: *Slots*, *Jackpots*, *Live Casino*, *Table*, *Slingo*, *Bingo*, *Instant*, *Arcade*.
...
#### Description 3 — *SEARCH · FILTER MENU — User searches for a bingo game through filter menu* (iOS · 375×812)

> Demonstrates **special-case flow** when a category(game type) has **no child filters** (Bingo).
...
5. **Back to main categories(game types)**
   ...
   * The user can return to the category(game type) grid to adjust **Game Type** again.

---

#### Description 4 — *SEARCH · FILTER MENU — All categories(game types)* (iOS · 375×812)

> Shows the **facet consistency** across categories(game types) and reinforces the **ordered flow**.
...
* The **prescribed order** is consistently demonstrated: **Game Type → Feature → Provider → Reel** (with category(game type)-specific variants like Stake Range or Type of Game).
...
### 11. Quick Filters should display relevant games

**Acceptance Criteria**

Given that I am a customer
When I have clicked on a Quick Filter
Then only games relevant to that filter should be displayed
And if I have chosen multiple filters
Then only games relevant to the filters selected should be displayed
...
7. **Comparative UI references (for clarity of patterns).**
   ...
   * **Spotify** example: a **persistent “X”** appears when any filters are active to **clear all**. These references reinforce **visibility of applied filters** and **easy removal**, ensuring grids always reflect **current active filters**.
...
2. **category(game type) selection (Slots).**

   * The modal shows **category(game type) tiles** (Slots, Jackpots, Live Casino, Table, Slingo, Bingo, Instant, Arcade).
   * User selects **Slots**.
...
### 12. Add Game Filter to the search page

**Acceptance Criteria**

Given that I am a customer
When I am on the search page
Then I should have access to a Game Filter option
And when it is clicked, it should load up the Game Filter menu where I can see the main categories(game types) (game types)
...
* The modal lists **main categories(game types)** as large icon buttons: *Slots*, *Jackpots*, *Live Casino*, *Table*, *Slingo*, *Bingo*, *Instant*, *Arcade*.

---

#### Description 1 — *SEARCH · FILTER MENU — User searches for a slot game through filter menu* (iOS · 375×812)

**Purpose:** The Search page exposes an explicit **“Game Filter”** entry point that opens a full-screen modal for deep facet selection. Users can select a **category(game type)** (e.g., Slots) and then choose **child filters** before applying with a sticky **SHOW X GAMES** button.
...
2. **Game Filter modal — main category(game type) grid**

   * A full-screen panel titled **GAME FILTER** slides up.
   * It presents **eight large category(game type) cards** with icons and labels: **Slots**, **Jackpots**, **Live Casino**, **Table**, **Slingo**, **Bingo**, **Instant**, **Arcade**.
   * A persistent **footer CTA** reads **SHOW X GAMES** (disabled until a selection is actionable).
   * **User taps “Slots.”**
3. **category(game type) → child facet view (Slots)**
   ...
   * **Facet groups** appear vertically:
     ...
     * Additional, category(game type)-specific groups may follow (e.g., Reels, Themes, Win Lines).
...
#### Description 2 — *SEARCH · FILTER MENU — User searches for a bingo game through filter menu* and *All categories(game types)*

**Purpose:** The **Game Filter** entry supports all categories(game types) and handles **special cases**. For **Bingo**, there are **no child filters**; selecting the category(game type) immediately shows results. A separate “All categories(game types)” panel shows the **facet consistency** for categories(game types) like **Slots**, **Jackpot**, **Live Casino**, and **Table**.

1. **Bingo flow — no child filters**

   * From Search, user taps **Game Filter** → **GAME FILTER** category(game type) grid.
   * **User selects “Bingo.”**
...
2. **All categories(game types) — facet structure by type**
...
* Users **pick a category(game type) first**, then **refine via child facets** (or immediately see results if the category(game type) has no children, like Bingo).
...
### 13. Game Filters can be added to the Game Filter Menu using Contentful

**Acceptance Criteria**

Given that I am a Bally's Employee using the CMS
When I am configuring the Game Filters in the Game Filter Menu
Then I should be able to add and remove Filters
And the customer should see the filters I have configured
...
### 14. Game Filters are configurable in Contentful

**Acceptance Criteria**

Given that I am a Bally's Employee using the CMS
When I am configuring Game Filters Filters
Then I should be able to change the order the all Game Filters that are presented to customer
...
### 15. Ability to apply filters in the Game Filter menu

**Acceptance Criteria**

Given that I am a customer
And I am viewing the Game Filter menu
When I click on one of the main categories(game types) e.g. slots
Then I should be able to see all the child filters of the category(game type)
...
#### Description 1 — GAME FILTER (iOS · 375×812) — Selecting and combining child facets
...
4. **Real-time feedback & validation**
   ...
   * CTA is **enabled** when at least one actionable filter/category(game type) is applied.
5. **Removal & reset**
...
#### Description 2 — GAME FILTER (iOS · 375×812) — Multi-selection state and confirmation
...
### 16. When filters are applied, relevant games should be shown

**Acceptance Criteria**

Given that I am a customer
And I have applied filters in the Game Filter menu
When I click the 'Show X Games' button
Then I should see games that are relevant to the filters I have applied
...
#### Description 1 — *Post-apply state from Quick Filters / Game Filter (iOS · 375×812)*
...
#### Description 2 — *Applied filters visible in GAME FILTER and reflected on Search (iOS · 375×812)*
...
### 17. Direct customers straight to games when Bingo is selected as a filter

**Acceptance Criteria**

Given that I am a customer
When I filter Bingo as the game type
Then I should see a list of games without having the option to choose additional filters
This is because there are no child filters for Bingo
...
#### Description 1 — *SEARCH · FILTER MENU — User searches for a bingo game through filter menu* (iOS · 375×812)

**Example UI/UX:** **Bingo** is a **top-level category(game type) with no child facets.** Selecting it should **immediately route** the user to a Bingo-only results view—skipping intermediate filter steps.
...
1. **Search page (idle) with Game Filter entry**
   ...
   * **User taps “Game Filter.”**
2. **GAME FILTER modal — main categories(game types)**

   * A full-screen modal titled **GAME FILTER** slides up.
   * It shows **eight large category(game type) tiles** with icon + label: *Slots, Jackpots, Live Casino, Table, Slingo, Bingo, Instant, Arcade*.
...
5. **Clearing Bingo**
   ...
   * From the reopened modal, tapping the **“×”** on the **Bingo** pill clears the category(game type); user can pick a new top-level category(game type) (e.g., Slots).
...
#### Description 2 — *SEARCH · FILTER MENU — All categories(game types) (Bingo behavior contrasted with others)* (iOS · 375×812)

**What the panel shows:** A comparative look at **facet structures** for other categories(game types) (Slots, Jackpot, Live Casino, Table) versus **Bingo’s special case**.

1. **Other categories(game types) (Slots, Jackpot, Live Casino, Table)**
...
* **Removal / change of mind:** Clearing the **[Bingo]** pill (in the modal or on Search) **broadens** results and allows selection of a **different category(game type)**—mirroring the pattern used for all other filters.

---

### 18. Ability to remove filters
...
Then I should have the ability to remove 1 or multiple filters
...
#### Description 1 — *GAME FILTER modal with Active Filters pills (iOS · 375×812)*

**Example UI/UX:** Users can **see every applied constraint** and **remove one or many** directly inside the **GAME FILTER** modal.
...
#### Description 2 — *Search screen with Applied Filters bar (iOS · 375×812)*

**Example UI/UX:** Users can also **remove filters directly from the Search screen** without reopening the modal.
...
### 19. Ability to view applied filters

**Acceptance Criteria**

Given that I am a customer
And I have applied a filter
When I want to view the filters that I have applied
Then I should have the ability to view all of the filters I have applied
...
#### Description 1 — *Search page after filters have been applied (iOS · 375×812)*
...
#### Description 2 — *GAME FILTER modal showing the applied filters list (iOS · 375×812)*
...
1. **Complete, centralized view of what’s applied**
   ...
   * This strip lists **every current selection** as a pill (e.g., category(game type), features, provider, reels/lines/themes). This provides a **single, comprehensive view** of the applied set.
...
### 20. Handling of multiple languages

**Acceptance Criteria**

Given that I am a customer
When I am on the search page
Then the UI and search logic should support my chosen language/language of the country I am playing in
...
### 21. Search results should load quickly

**Acceptance Criteria**

Given that I am a customer
When I search for a game by filter or by typing in the search bar
Then I should see my results within 2 seconds
This includes caching and the displaying of the results
...
### 22. Ordering the games based on Margin

**Acceptance Criteria**

Given that I am a customer
And I search for a game by filter or by typing in the search bar
When I see the results
Then the games should be ordered highest margin to lowest margin
...
### 23. Update the search UI to latest designs

**Acceptance Criteria**

Given that I am a customer
When I go to the search page
Then I should see the latest designs and UX guidelines
And it should adjust dependant on device
...
### 24. Retain Player Search History

**Acceptance Criteria**

Given that I am a logged in customer
And I have previously searched for a game
When I begin to search for a game
Then I should see my last 5 searches
...
### 25. Show Popular Searches

**Acceptance Criteria**

Given that I am a customer
When I click on the search bar
Then I should see a list of popular games
And be able to load the game by clicking on it
...
### 26. Ability to configure 'Popular Searches'

**Acceptance Criteria**

Given that I am a Ballys employee using the CMS
When I am configuring the games that appear under 'Popular Searches'
Then I should be able to choose which games to show based on highest bets, highest GGR, most played etc.
...
### 27. Ability to configure default content on the Search Page

**Acceptance Criteria**

Given that I am a Ballys Employee using the CMS
When I am configuring the search page
Then I should be able to add categories(game types) of games the customer can choose from, before they have searched for a game (e.g. Game Collections, Popular Games etc.)

Given that I am a customer
When I am on the search page
And I have not searched for a game
Then I will see categories(game types) of games that have been configured in the CMS
This is to ensure the Search Page is not blank

Content to be decided by Game /Product Ops
...
### 28. Game Collections to be visible on the search page

**Acceptance Criteria**

Given that I am a customer
When I am on the search page
Then I should be able to see a carousel of Game Collections
...
### 29. Ability to find games via Game Collections

**Acceptance Criteria**

Given that I am a customer
And I am on the search page
When I click on one of the game collections
Then I should be taken to games that fall under that collection
...
### 30. Update Google Analytics for Effective Monitoring

**Acceptance Criteria**

Given that I am a Bally's Employee using Google Analytics
Then I should be able to see results on how customer's use search
We already have google analytics tagged for our existing search. Make sure the enhanced search features are captured
...
Then a basic search functionality should be applied
